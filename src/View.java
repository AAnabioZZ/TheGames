...
public class View {
    ...
    public static void view() {
        ...
        step++;
        Main.initiative.forEach((v) -> l[0] = Math.max(l[0], v.toString().length()));
        ...
        System.out.print("|    ");
        System.out.print(Main.comandA.get(0));
        tabSetter(Main.comandA.get(0).toString().length(), l[0]);
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("|    ");
            System.out.print(Main.comandA.get(i-1));
            tabSetter(Main.comandA.get(i-1).toString().length(), l[0]);
            System.out.println(Main.comandB.get(i-1));
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|    ");
        System.out.print(Main.comandA.get(9));
